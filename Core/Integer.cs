...
namespace Integers
{
    ...
    public class Integer
    {
        ...
        private bool IsZero => digits.Count == 0 || digits.All(x => x == 0) || this == Zero;
        ...
        private Integer(Sign sign, IEnumerable<byte> bytes)
        {
            Sign = Sign.Plus;
            Sign = sign;
            digits = bytes.ToList();
        ...
        private static IEnumerable<byte> GetBytes(uint num)
        {
